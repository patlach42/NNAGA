...
ExternalProject_Add(cairo
    ...
    PATCH_COMMAND /bin/bash -c "patch -d <SOURCE_DIR> -p1 -R --dry-run -i '${PROJECT_ROOT}/cmake/patches/cairo_android_no_fontconfig.patch' >/dev/null 2>&1 || (patch -d <SOURCE_DIR> -p1 --dry-run -i '${PROJECT_ROOT}/cmake/patches/cairo_android_no_fontconfig.patch' >/dev/null 2>&1 && patch -d <SOURCE_DIR> -p1 -i '${PROJECT_ROOT}/cmake/patches/cairo_android_no_fontconfig.patch')"
