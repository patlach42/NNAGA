...
set(_nnaga_native_output "${JNILIBS_DIR}/libnnaga_plugin_filter.so")
add_custom_command(
    OUTPUT "${_nnaga_native_output}"
    COMMAND ${CMAKE_COMMAND} -E make_directory "${JNILIBS_DIR}"
    COMMAND ${CMAKE_COMMAND} -E copy_if_different "$<TARGET_FILE:nnaga_plugin_filter>" "${_nnaga_native_output}"
    DEPENDS nnaga_plugin_filter
    COMMENT "Staging NNAGA Native filter")
add_custom_target(nnaga_native_filter_done DEPENDS "${_nnaga_native_output}")
